                  ...
                  >
                    <div className="flex flex-col truncate mr-2">
                      <div className="flex items-center gap-1.5">
                        ...
                        {isRunning && (
                          <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0" title={t.models.activeStatus} />
                        )}
                      </div>
                    ...
                    {isSelected && (
                      <Check size={14} className="text-blue-400 shrink-0" strokeWidth={1.5} />
                    )}
                  </button>
                );
              })
