    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 animate-in fade-in duration-150">
      <div className="bg-zinc-900 border border-zinc-700/80 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-semibold text-zinc-100">
                Komut Çalıştırma İzni
              </h2>
              <p className="text-xs text-zinc-400">
                Ajan izole ortamda bir test veya derleme komutu koşturmak istiyor.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 space-y-3.5 text-xs">
          <div>
            <span className="text-zinc-400 block mb-1.5 font-medium">Çalıştırılacak Komut:</span>
          ...
          <div className="p-2.5 rounded bg-emerald-950/30 border border-emerald-900/40 text-[11px] text-emerald-300 flex items-center gap-2">
            ...
            <span>
              Süreç İzolasyonu: Yalnızca allowlist değişkenleri (PATH, TEMP vb.) aktarılır; ana makinedeki gizli API anahtarları sızdırılamaz.
            </span>
          </div>
        </div>
